...
class MainWindow(QWidget):
    def __init__(self):
        ...
        left_scroll = self.settings.value("left_scroll")
        right_scroll = self.settings.value("right_scroll")

        if left_scroll is not None:
            self.left.tree.verticalScrollBar().setValue(int(left_scroll))

        if right_scroll is not None:
            self.right.tree.verticalScrollBar().setValue(int(right_scroll))
